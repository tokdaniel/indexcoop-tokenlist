...
| `is[Type]Token` | `:is [TokenType]` | typeguard to safely cast into the necessary tokentype: `TokenInfo`, `ListedToken`, `IndexToken`, `ProductToken`,  `LeverageToken`, `SectorToken`, `YieldToken`, `CurrencyToken`|
